#ifndef GPHOTO2PP_TESTS_CAMERALISTWRAPPER_NODEVICE_H_  // NOLINT
#define GPHOTO2PP_TESTS_CAMERALISTWRAPPER_NODEVICE_H_
/** \file
...
class CameraListWrapper_NoDevice : public CxxTest::TestSuite {
 public:
    ...
    void testConstructionAndReAssignmentWithSort() {
        ...
        TS_ASSERT_THROWS(cameraList.getName(10), const gphoto2pp::exceptions::gphoto2_exception&);  // out of bounds
    }
    ...
    void testFindByName() {
        ...
        TS_ASSERT_THROWS(cameraList.findByName("First"), const gphoto2pp::exceptions::gphoto2_exception&);
    ...
    void testDuplicatesWithFindByName() {
        ...
        cameraList.append("First Model", "Some Port1");
        cameraList.append("First Model", "Some Port1");
        // Should I make the append method throw an error if the model aleady exists on the port? Best to ask Marcus
    ...
    void testCopyAndAssignmentOperators() {
...

        {
            ...
            TS_ASSERT_THROWS(cameraList.count(), const gphoto2pp::exceptions::gphoto2_exception&);
